...
const slides = [
  (
      ...
      <img className="product-picture-slider" alt="Furniture Melodic Nest" src="img/furniture1.png" />
    </div>
  ),
  (
    <div className="slider-content flex">
      ...
      <img className="product-picture-slider" alt="Stockholm Sofa" src="img/furniture2.png" />
          </div>
  ),
  (
    <div className="slider-content flex">
      ...
      <img className="product-picture-slider" alt="Berlin Cabinet" src="img/furniture3.png" />
    </div>
  ),
];
